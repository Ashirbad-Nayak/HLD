...
export const completeUpload = async (req, res) => {
    try {
        ...
        console.log("Publishing message to ksfka for tasnscode service to pick up and start its job");
        pushVideoForEncodingToKafka(title,filename);

        console.log("Pusing video details to Open search")
...
//prisma  just for testing from postman
